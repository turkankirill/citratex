...
// limitations under the License.
  ...
  public class HeartbeatLoggingTestUtils: NSObject {
    ...
    public static func removeUnderlyingHeartbeatStorageContainers() throws {
      #if os(tvOS)
        UserDefaults().removePersistentDomain(forName: ImmutableValues.heartbeatUserDefaultsSuiteName)
      #else
        ...
        let heartbeatsDirectoryURL = applicationSupportDirectory
          .appendingPathComponent(
            ImmutableValues.heartbeatFileStorageDirectoryPath, isDirectory: true
          )
        do {
